%% HIL Metric Extractor & Plotter
clear; clc; close all;

% --- MANUAL CONFIGURATION ---
filename = 'HIL_MPC_11.csv';  % <--- Change this for each run
target_dist = 11;             % <--- Change this to match (11, 510, or 1010)
% -----------------------------
...
xlabel('Time (seconds)');
title('HIL MPC Performance Analysis: 1010mm Distance');
